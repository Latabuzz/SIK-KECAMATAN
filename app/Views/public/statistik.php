...
<main class="container mx-auto px-4 py-8">
    ...
    <div class="space-y-4 md:space-y-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            <div class="bg-white rounded-lg shadow p-3 md:p-6 card-hover transition-all border-l-4 border-l-blue-500">
                <div class="flex items-center justify-between mb-2 md:mb-4">
                    <h3 class="text-xs md:text-sm font-medium text-gray-600">Total Penduduk</h3>
                ...
                <div class="text-lg md:text-2xl font-bold"><?= $statistics['total'] ?></div>
                <p class="text-xs text-gray-600">Jiwa terdaftar</p>
            </div>

            <div class="bg-white rounded-lg shadow p-3 md:p-6 card-hover transition-all border-l-4 border-l-blue-500">
                <div class="flex items-center justify-between mb-2 md:mb-4">
                    <h3 class="text-xs md:text-sm font-medium text-gray-600">Laki-laki</h3>
                    <svg class="w-6 h-6 md:w-8 md:h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                </div>
                <div class="text-lg md:text-2xl font-bold"><?= $statistics['laki_laki'] ?></div>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-6 card-hover transition-all border-l-4 border-l-pink-500">
                <div class="flex items-center justify-between mb-2 md:mb-4">
                    <h3 class="text-xs md:text-sm font-medium text-gray-600">Perempuan</h3>
                    <svg class="w-6 h-6 md:w-8 md:h-8 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                </div>
                <div class="text-lg md:text-2xl font-bold"><?= $statistics['perempuan'] ?></div>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-6 card-hover transition-all border-l-4 border-l-green-500">
                <div class="flex items-center justify-between mb-2 md:mb-4">
                    <h3 class="text-xs md:text-sm font-medium text-gray-600">Status Kawin</h3>
                ...
                <div class="text-lg md:text-2xl font-bold"><?= $statistics['kawin'] ?></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            <div class="bg-white rounded-lg shadow p-4 md:p-6">
                <h3 class="text-base md:text-lg font-semibold mb-4">Distribusi Jenis Kelamin</h3>
                <canvas id="genderChart"></canvas>
            </div>

            <div class="bg-white rounded-lg shadow p-4 md:p-6">
                <h3 class="text-base md:text-lg font-semibold mb-4">Distribusi per Desa</h3>
                <canvas id="villageChart"></canvas>
            </div>

            <div class="bg-white rounded-lg shadow p-4 md:p-6 lg:col-span-2">
                <h3 class="text-base md:text-lg font-semibold mb-4">Tingkat Pendidikan</h3>
