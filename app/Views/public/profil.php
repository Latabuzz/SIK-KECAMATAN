...
<main class="container mx-auto px-4 py-8">
    ...
    <div class="grid gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold mb-4 text-blue-600">Tentang Kecamatan Madidir</h2>
        ...
        <!-- Data Umum -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-xl font-bold mb-4 text-blue-600">Data Umum</h3>
            <div class="grid md:grid-cols-2 gap-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold">45.2 km²</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold"><?= number_format($totalPenduduk ?? 8, 0, ',', '.') ?> Jiwa</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-500">Jumlah Desa/Kelurahan</p>
                        <p class="font-semibold">4 Desa</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-500">Kepadatan Penduduk</p>
                        <p class="font-semibold"><?= number_format(($totalPenduduk ?? 8) / 45.2, 0) ?> Jiwa/km²</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Batas Wilayah -->
        <div class="bg-white rounded-lg shadow-md p-6">
            <h3 class="text-xl font-bold mb-4 text-blue-600">Batas Wilayah</h3>
            <div class="grid md:grid-cols-2 gap-4">
                <div class="border-l-4 border-blue-500 pl-4">
                    <p class="text-sm text-gray-500">Sebelah Utara</p>
                    <p class="font-semibold">Kecamatan Bintang</p>
                </div>
                <div class="border-l-4 border-green-500 pl-4">
                    <p class="text-sm text-gray-500">Sebelah Selatan</p>
                    <p class="font-semibold">Kecamatan Serasan</p>
                </div>
                <div class="border-l-4 border-purple-500 pl-4">
                    <p class="text-sm text-gray-500">Sebelah Barat</p>
                    <p class="font-semibold">Selat Karimata</p>
                </div>
                <div class="border-l-4 border-yellow-500 pl-4">
                    <p class="text-sm text-gray-500">Sebelah Timur</p>
                    <p class="font-semibold">Kecamatan Palmatak</p>
                </div>
            </div>
        </div>
